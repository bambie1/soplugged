  ...
  return (
    <section className="light-gradient relative mt-20 mb-20 pt-5 pb-12 lg:pt-10">
      <div className="my-container grid items-center gap-12 lg:grid-cols-2 lg:gap-10">
        <div className="mt-10">
          <ul className="flex flex-col flex-wrap gap-8 md:flex-row md:justify-center">
            {locationImages.map(({ city, cityFull, category, url }) => (
              <li
                key={city}
                className="relative odd:ml-4 odd:self-start even:self-end md:odd:ml-0 md:odd:self-auto md:even:self-auto"
              >
                <img
                  src={url}
                  alt=""
                  className="absolute -top-5 -left-5 z-[1] aspect-square w-14 rounded-full object-cover shadow-lg"
                />
                <button
                ...
                >
                  ...
                  <p className="text-lg uppercase lg:text-xl">{city}</p>
                </button>
              </li>
            ))}
          </ul>
        ...
        <aside>
          ...
          <p className="mb-4 font-medium lg:text-lg">

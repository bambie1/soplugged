...
const CustomHit: FC<HitProps> = ({ hit }) => {
  ...
  return (
    <Link href={`/business/${slug}`}>
      <a className="relative flex h-full flex-col items-start rounded-lg bg-light p-4 shadow transition  duration-200 hover:border-secondary/60 hover:bg-white hover:shadow-md focus:border-primary focus-visible:border-primary">

...
const Dashboard = ({ data }) => {
  ...
  const hasLogo = data.logo_url !== "" && false;
  const hasGoodDescription = data.business_description.length > 150 && false;
  const hasThreeImages = data.sample_images.split(",").length === 3 && false;
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <Paper elevation={2} className={classes.activity}>
                ...
                <Typography>
                  Your wish is our command. Let us know what changes you'd like

      ...
      <main className="relative mb-20">
        ...
        <div className="my-container relative">
          ...
          <div
            ...
            className="prose mx-auto mt-6 mb-10 border-t pt-6 prose-h2:mb-2 prose-h2:text-primary prose-a:text-primary prose-strong:font-semibold prose-img:rounded-lg lg:prose-lg lg:mb-20 lg:prose-h2:mb-2 xl:mt-0 xl:border-none"
          />

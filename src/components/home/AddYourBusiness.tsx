...
const AddYourBusiness = () => {
  return (
    <div className="my-container">
      <div
        className={`relative w-full gap-10 overflow-hidden rounded-lg bg-gradient-to-tr from-accent/50 to-secondary/50 py-8 px-6 text-center shadow backdrop-blur-[1px] md:p-10 lg:grid-cols-5 xl:py-32 xl:px-16`}
      >

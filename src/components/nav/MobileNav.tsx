      ...
      <header className={clsx("fixed left-0 top-0 z-50 w-full")}>
        <div
          className={clsx("w-full transition-all duration-300", {
            "border-white/50 bg-black/80": isScrolled && !isLight,
            "border-black/20 bg-white/80": isScrolled && isLight,
            "border-b": isScrolled && !isMenuOpen,
      ...
      <AnimatePresence mode="wait">
        {isMenuOpen && (
          <motion.div
            ...
            exit="exit"
            className={clsx(
              "fixed right-0 top-0 z-40 h-screen w-screen bg-opacity-80 backdrop-blur-lg",

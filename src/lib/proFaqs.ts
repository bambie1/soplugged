...
export const proFaqs = [
  ...
  },
  {
    ...
    answer:
      "While we do offer amazing FREE guides to help your business, our design and marketing services are paid, and will be discussed during our FREE consultation session!",
  },
];
